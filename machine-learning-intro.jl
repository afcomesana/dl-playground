...
begin
	...
	y_coords = map(x_coord -> target(x_coord) + rand(gaussian_noise), x_coords)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "efa92dcae73fbcf68ecad4ceabfd251b25fb7be6"
