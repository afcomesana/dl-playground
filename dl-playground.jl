...
# ╔═╡ 24eba206-7425-11ed-03e0-0f050ebad56e
begin
	using Flux
	using Plots
	using CSV
...
# ╔═╡ 3762bbdd-6b06-4fdc-b89b-6c2ece07907d
begin
	# Simple model
	layer1 = Dense(1, 1)
	layer2 = Dense(1, 1)
	test_model = Chain(layer1, layer2)
end

# ╔═╡ c1a0be22-7b3a-4557-ab13-57626581eccd


# ╔═╡ 23c53edc-337e-4fbd-8c44-24249090bdd9
html"<h3>Model from machine learning basics notebook</h3>"

# ╔═╡ 9636d5b5-8443-453d-be2c-f06ea4adbebe
begin
	model = Dense(2, 1, σ)
	# model.weight
	# model.bias
	...
	# this is the same made manually:
	σ(model.weight*test_input + model.bias)

end

# ╔═╡ 4aa24f8c-7004-438c-9fb9-79eb74c9a64b
html"<h3>Import COVID data</h3>"

# ╔═╡ 49d4d255-b56e-47b5-9d0d-9aa3fc22c39e
df = DataFrame(CSV.File("covid-data-shortened.csv"))

# ╔═╡ 861b0f98-be01-4949-818a-f9b076ad2c35
begin
	train_x = [[row.SEX, row.AGE] for row in eachrow(df)]
	train_y = df.DATE_DIED .!= "9999-99-99"
	train_y = convert(Array{Int}, train_y)
end

# ╔═╡ 39e7caf0-97e4-4198-afe2-7e800fc4ae60
begin
	Flux.mse(model(train_x[1]), train_y[1])
end
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "5e39b2a5ccf87f0d8ef18ad9b3b752afd04e1ca2"
